...
from ..utils import A1_aln_numerical as opti1_numerical
from ..utils import M1_noise as M1_noise
from ..utils import M2_noise as M2_noise
from ..utils import M3_noise as M3_noise
from ..utils import M4_noise as M4_noise
from ..utils import A1_aln_network as A1_network
            ...
            if numerical == False:
                if self.params.N == 1:
                    if noise_real == 0:
                        ...
                        if method == 'M1':
                            return M1_noise.M1(self, noise_real, init_params, control_, target_state_, c_scheme_, u_mat_, u_scheme_, max_iteration_,
                                                    tolerance_, startStep_, max_control_, min_control_, t_sim_, t_sim_pre_, t_sim_post_, CGVar,
                                                    line_search_, control_variables_, prec_variables_, separate_comp, transition_time_)
                        elif method == 'M2':
                ...
                return opti1_numerical.A1(self, control_, target_state_, c_scheme_, u_mat_, u_scheme_, max_iteration_,
                                                    tolerance_, startStep_, max_control_, min_control_, t_sim_, t_sim_pre_, t_sim_post_, CGVar,
                                                    line_search_, control_variables_, prec_variables_, separate_comp, transition_time_)
