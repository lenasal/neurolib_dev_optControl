...
def loadDefaultParams(Cmat=None, Dmat=None, lookupTableFileName=None, seed=None):
    ...
    params.ext_ee_rate = 0.0  # kHz external excitatory type rate drive to excitatory population
    params.ext_ei_rate = 0.0  # kHz external inhibitory type rate drive to excitatory population
    params.ext_ie_rate = 0.0  # # kHz external excitatory type rate drive to inhibitory population
    params.ext_ii_rate = 0.0  # # kHz external inhibitory type rate drive to inhibitory population
